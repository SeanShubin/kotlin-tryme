...
object IoUtil {
    fun inputStreamToLineEvent(inputStream: InputStream, charset: Charset, lineEvent: (String) -> Unit) {
        val reader = InputStreamReader(inputStream, charset)
        readerToLineEvent(reader, lineEvent)
    }

    fun readerToLineEvent(reader: Reader, lineEvent: (String) -> Unit) {
